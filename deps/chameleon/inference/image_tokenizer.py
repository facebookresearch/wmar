...
"""
Run with:
    python -m chameleon.inference.image_tokenizer
"""
...
import torch
import yaml
from deps.chameleon.inference.vqgan import VQModel
...
class ImageTokenizer:
    ...
    def pil_from_img_toks(self, img_tensor: torch.Tensor, return_chw: bool = False) -> Union[PIL.Image, tuple[PIL.Image, torch.Tensor]]:
        ...
        if return_chw:
            return self._pil_from_chw_tensor(pixels[0]), pixels[0]
        else:
