...
from deps.rar.utils.logger import setup_logger

from deps.rar.utils.train_utils import (
...
def main():
    ...
    tokenizer = get_tatitok_tokenizer(config)
    ...
    model, clip_encoder, loss_module, optimizer, lr_scheduler = accelerator.prepare(
        model, clip_encoder, loss_module, optimizer, lr_scheduler
    )
