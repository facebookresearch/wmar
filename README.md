...
- **Taming**. You need to manually download the model weights following the instructions from the [official repo](https://github.com/CompVis/taming-transformers) and place them in e.g., `checkpoints/`.
  In particular, go to https://app.koofr.net/links/90cbd5aa-ef70-4f5e-99bc-f12e5a89380e and download it to `checkpoints/2021-04-03T19-39-50_cin_transformer`, setting that path as `--modeldir` flag when executing the code (see below).
