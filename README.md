...
- **19th September 2024**: New work on watermark synchronization! Check out [SyncSeal](https://arxiv.org/abs/2506.16349) - an active method for synchronizing images and improving robustness against desynchronization attacks. Code is available in the [`syncseal/`](11-autoregressive/wmar_fbresearch/syncseal) folder.
